...
- **CAGRA SYCL B2 checkpoint:** work-group/query, SLM candidates, bounded hash, cooperative distance, and forced-policy honesty are implemented. On the final 2K smoke, recall@10 was 0.990625 at `itopk=32/search_width=1` versus hnswlib 0.99375, but QPS was about 7.4K versus 71.7K. Index dataset/graph vectors attempt shared USM; strict no-fallback/transfer telemetry at SIFT1M, hash seeds, serial selection/sort, and SIFT1M quality/performance remain open. Evidence: `tables/arrow-lake/bench-recall-qps.md`.
